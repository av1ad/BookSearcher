      ...
      <div className="min-h-screen max-w-md mx-auto px-4 py-16">
        <div className="bg-[#D9D9D9] bg-opacity-5 p-8 rounded-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label htmlFor="name" className="block text-[#a9c5a0] text-sm font-semibold mb-2">
                Name (optional)
              </label>
              <input
                type="text"
            ...
            <div>
              ...
              <input
                ...
                required
              />
              <p className="text-sm text-[#758173] mt-1">
          ...
          <p className="text-center text-[#758173] mt-6">
            ...
            <Link href="/login" className="text-[#a9c5a0] hover:underline">
              Login
            </Link>
          </p>
        </div>
