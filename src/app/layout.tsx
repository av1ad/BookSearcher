...
export const metadata: Metadata = {
  ...
  description: "Your AI-powered book discovery companion. Find personalized book recommendations, explore new genres, and uncover hidden literary gems with our intelligent search engine.",
  openGraph: {
  ...
  twitter: {
    ...
    description: 'Discover your perfect book match with AI-powered recommendations. From bestsellers to hidden gems, find exactly what you want to read next! ✨',
